...
class BaseAlgorithm(ABC):
    ...
    def _update_current_progress_remaining(self, num_timesteps: int, expected_total_timesteps: int) -> None:
        """
        ...
        """
        self._current_progress_remaining = 1.0 - float(num_timesteps) / float(expected_total_timesteps)
