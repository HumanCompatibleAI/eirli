...
for il in cfg_il_bc_nofreeze; do
    for bench in cfg_bench_micro_sweep_magical cfg_bench_micro_sweep_dm_control; do
        ...
        for repl in \
            ...
            "exp_ident=cpc_identity_aug repl.stooke_contrastive_hyperparams_dmc repl.identity_cpc_aug" \
            "exp_ident=ceb repl.stooke_contrastive_hyperparams_dmc repl.temporal_ceb_no_projection" \
            "exp_ident=ceb_beta0 repl.stooke_contrastive_hyperparams_dmc repl.temporal_ceb_no_projection_beta0" \
            ; do
