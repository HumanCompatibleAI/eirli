...
for il in cfg_il_bc_nofreeze; do
    ...
    for bench in cfg_bench_magical_mr cfg_bench_magical_mtc; do
        for repl in \
            "exp_ident=inv_dyn_rand_demos$froco cfg_data_il_5traj cfg_data_repl_random_demos cfg_repl_inv_dyn" \
            ...
            "exp_ident=vae_rand_demos$froco cfg_data_il_5traj cfg_data_repl_random_demos cfg_repl_vae" \
            ...
            "exp_ident=tcpc_aug_rand_demos$froco cfg_data_il_5traj cfg_data_repl_random_demos repl.stooke_contrastive_hyperparams_dmc repl.temporal_cpc_augment_both_magical repl.algo_params.batch_size=192" \
            "exp_ident=cpc_identity_aug_rand_demos$froco cfg_data_il_5traj cfg_data_repl_random_demos repl.stooke_contrastive_hyperparams_dmc repl.identity_cpc_aug repl.algo_params.batch_size=192" \
    ...
    for bench in cfg_bench_one_task_dm_control; do
        for repl in \
            "exp_ident=inv_dyn_rand_only$froco cfg_data_il_hc_extended cfg_data_repl_demos_random cfg_repl_inv_dyn" \
            "exp_ident=vae_rand_only$froco cfg_data_il_hc_extended cfg_data_repl_demos_random cfg_repl_vae" \
            "exp_ident=tcpc_aug_rand_only$froco cfg_data_il_hc_extended cfg_data_repl_demos_random repl.stooke_contrastive_hyperparams_dmc repl.temporal_cpc_augment_both_magical repl.algo_params.batch_size=192" \
            "exp_ident=cpc_identity_aug_rand_only$froco cfg_data_il_hc_extended cfg_data_repl_demos_random repl.stooke_contrastive_hyperparams_dmc repl.identity_cpc_aug repl.algo_params.batch_size=192" \
            ; do
