...
chain_ex = Experiment('chain', ingredients=[
...
def run_end2end_exp(rep_ex_config, il_train_ex_config, il_test_ex_config, benchmark_config, config, log_dir):
    """
...
def run(exp_name, metric, spec, representation_learning, il_train,
        il_test, benchmark, tune_run_kwargs):
