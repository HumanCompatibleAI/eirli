...
for seed_var in 1 2 3 :
  #success condition
  CUDA_VISIBLE_DEVICES="1" xvfb-run python -m il_representations.scripts.run_rep_learner with algo='MoCo' algo_params.representation_dim=10\
