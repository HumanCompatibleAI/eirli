...
def make_hp_tuning_configs(experiment_obj):
    ...
    def gail_tune():
        ...
        skopt_space = collections.OrderedDict([
            ...
            ('il_train:gail:ppo_init_learning_rate', (1e-7, 1e-3, 'log-uniform')),
            ...
            ('il_train:gail:disc_augs', [
                'rotate_ex,translate_ex', 'rotate_mid,translate_mid,erase',
        ...
        skopt_ref_configs = [
            collections.OrderedDict([
                ...
                ('il_train:gail:disc_augs', 'ajsdifojasodfjoasjdf,rotate_ex,translate_ex,erase,flip_ud,flip_lr,noise,gray'),
                ('venv_opts:n_envs', 24),
            ]),
        ]
