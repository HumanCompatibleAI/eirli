...
@pytest.mark.parametrize("benchmark_cfg", [BENCHMARK_TEST_CONFIGS[0]])
def test_algo(benchmark_cfg, represent_ex):
    represent_ex.run(config_updates={
        **REPL_SMOKE_TEST_CONFIG, 'algo': algos.CEB, 'benchmark': benchmark_cfg,
    })